...
VAR MOVIE BASE RELATION
    { MOVIE# MOVIE#, TITLE CHAR,
      YEAR YEAR, DIRECTOR# PERSON#,
...
MOVIE := RELATION {
    ...
    TUPLE { MOVIE# MOVIE#(107), TITLE "Batman & Robin",
            YEAR YEAR(1997), DIRECTOR# PERSON#(105),
            SCORE SCORE(3.5), VOTES 10577 },
    TUPLE { MOVIE# MOVIE#(110), TITLE "Sleepy Hollow",
            YEAR YEAR(1999), DIRECTOR# PERSON#(148),
            SCORE SCORE(7.5), VOTES 10514 },
    TUPLE { MOVIE# MOVIE#(112), TITLE "Three Kings",
            YEAR YEAR(1999), DIRECTOR# PERSON#(1070),
            SCORE SCORE(7.7), VOTES 10319 },
    TUPLE { MOVIE# MOVIE#(151), TITLE "Gattaca",
            YEAR YEAR(1997), DIRECTOR# PERSON#(2020),
            SCORE SCORE(7.4), VOTES 8388 },
    TUPLE { MOVIE# MOVIE#(213), TITLE "Blade",
            YEAR YEAR(1998), DIRECTOR# PERSON#(2861),
            SCORE SCORE(6.7), VOTES 6885 },
    TUPLE { MOVIE# MOVIE#(228), TITLE "Ed Wood",
            YEAR YEAR(1994), DIRECTOR# PERSON#(148),
            SCORE SCORE(7.8), VOTES 6587 },
    TUPLE { MOVIE# MOVIE#(251), TITLE "End of Days",
            YEAR YEAR(1999), DIRECTOR# PERSON#(103),
            SCORE SCORE(5.5), VOTES 6095 },
    TUPLE { MOVIE# MOVIE#(281), TITLE "Dangerous Liaisons",
            YEAR YEAR(1988), DIRECTOR# PERSON#(292),
            SCORE SCORE(7.7), VOTES 5651 },
    TUPLE { MOVIE# MOVIE#(373), TITLE "Fear and Loathing in Las Vegas",
            YEAR YEAR(1998), DIRECTOR# PERSON#(59),
            SCORE SCORE(6.5), VOTES 4658 },
    TUPLE { MOVIE# MOVIE#(432), TITLE "Stigmata",
            YEAR YEAR(1999), DIRECTOR# PERSON#(2557),
            SCORE SCORE(6.1), VOTES 4141 },
    TUPLE { MOVIE# MOVIE#(433), TITLE "eXistenZ",
            YEAR YEAR(1999), DIRECTOR# PERSON#(97),
            SCORE SCORE(6.9), VOTES 4130 },
    TUPLE { MOVIE# MOVIE#(573), TITLE "Dead Man",
            YEAR YEAR(1995), DIRECTOR# PERSON#(175),
            SCORE SCORE(7.4), VOTES 3333 },
    TUPLE { MOVIE# MOVIE#(1468), TITLE "Europa",
            YEAR YEAR(1991), DIRECTOR# PERSON#(615),
            SCORE SCORE(7.6), VOTES 1042 },
    TUPLE { MOVIE# MOVIE#(1512), TITLE "Suspiria",
            YEAR YEAR(1977), DIRECTOR# PERSON#(2259),
            SCORE SCORE(7.1), VOTES 1004 },
    TUPLE { MOVIE# MOVIE#(1539), TITLE "Cry-Baby",
            YEAR YEAR(1990), DIRECTOR# PERSON#(364),
            SCORE SCORE(5.9), VOTES 972 }
};
