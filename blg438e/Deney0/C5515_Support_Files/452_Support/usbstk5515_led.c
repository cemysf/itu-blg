...
Int16 USBSTK5515_ULED_init( )
{
    ...
    USBSTK5515_GPIO_setDirection( 14, GPIO_OUT );
    USBSTK5515_GPIO_setDirection( 15, GPIO_OUT );
    USBSTK5515_GPIO_setDirection( 16, GPIO_OUT );
    USBSTK5515_GPIO_setDirection( 17, GPIO_OUT );
