...
{
	system("clear");
	printf("1 : Get step size of device 1\n");
	printf("2 : Set step size of device 1\n");
	printf("3 : Get step size of device 2\n");
	printf("4 : Set step size of device 2\n");
	printf("5 : Get counter\n");
	printf("6 : Set counter\n");
	printf("7 : Set rotate mode\n");
	printf("8 : Set eof mode\n");
	printf("9 : Get starting value of device 1\n");
	printf("10 : Set starting value of device 1\n");
	printf("11: Get starting value of device 2\n");
	printf("12: Set starting value of device 2\n");
	printf("13: Get ending value of device 1\n");
	printf("14: Set ending value of device 1\n");
	printf("15: Get ending value of device 2\n");
	printf("16: Set ending value of device 2\n");
	printf("0 : Exit\n");
	printf("Select one: ");
}
    ...
    while(loop)
    {
	    ...
	    switch(select)
	    {
	    	case 0:
		 	...
		 	case 1:
			    retval = ioctl(fd, RANGE_GET_STEP_SIZE_1, &arg);
			    if(retval)
			    	printf("Error :%s\n", strerror(errno));
			    else
			    	printf("RANGE_GET_STEP_SIZE_1: %d\n", arg);
			    getchar();
			break;
		 	...
		 	case 2:
		 		printf("Value: ");
		 		scanf("%d", &value);
			    retval = ioctl(fd, RANGE_SET_STEP_SIZE_1, &value);
			    if(retval)
			    	printf("Error :%s\n", strerror(errno));
			    else
			    	printf("RANGE_SET_STEP_SIZE_1: %d\n", value);
			    getchar();
			break;

		 	case 3:
			    retval = ioctl(fd, RANGE_GET_STEP_SIZE_2, &arg);
			    if(retval)
			    	printf("Error :%s\n", strerror(errno));
			    else
			    	printf("RANGE_GET_STEP_SIZE_2: %d\n", arg);
			    getchar();
			break;
		 	...
		 	case 4:
		 		printf("Value: ");
		 		scanf("%d", &value);
			    retval = ioctl(fd, RANGE_SET_STEP_SIZE_2, &value);
			    if(retval)
			    	printf("Error :%s\n", strerror(errno));
			    else
			    	printf("RANGE_SET_STEP_SIZE_2: %d\n", value);
			    getchar();
			break;
